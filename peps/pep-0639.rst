...
- Describes a :ref:`reference implementation <639-reference-implementation>`,
  includes :ref:`detailed examples <639-examples>` and
  :ref:`user scenarios <639-user-scenarios>` to enable project and tool
  authors smooth transition.

- Includes numerous additional contents, like
  :ref:`potential alternatives <639-rejected-ideas>`,
  results of the license documentation surveys
...
The takeaways from the survey have guided the design and recommendations of
this PEP:
